...
access(all) fun testStageContractSucceeds() {
    ...
    Test.assertEqual("Foo", evt.contractIdentifier)
...
access(all) fun testStageMultipleContractsSucceeds() {
    ...
    Test.assertEqual("C", cEvt.contractIdentifier)
    ...
    Test.assertEqual("B", bEvt.contractIdentifier)
    ...
    Test.assertEqual("A", aEvt.contractIdentifier)
...
access(all) fun tickTock(advanceBlocks: UInt64, _ signer: Test.TestAccount) {
